...
?>
        <div class="main">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="margin-bottom: 0;">결제 내역</h4>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th class="text-center align-content-center" style="width:150px;">
                                    주문번호
                                </th>
                                <th class="text-center align-content-center" style="width:150px;">
                                    주문상태
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center align-content-center"><b>자료가 없습니다.</b></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
